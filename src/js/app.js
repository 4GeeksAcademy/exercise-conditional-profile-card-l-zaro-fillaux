...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            ...
            <li><a href="https://www.linkedin.com/in/${variables.linkedin}/?originalSubdomain=es"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://www.instagram.com/${variables.instagram}?__d=1"><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
